...
# Update the AdaBoostClassifier to specify algorithm='SAMME'
for x in xs:
    clf = AdaBoostClassifier(n_estimators=x, algorithm='SAMME')
...
clf = AdaBoostClassifier(n_estimators=best_x, algorithm='SAMME')
